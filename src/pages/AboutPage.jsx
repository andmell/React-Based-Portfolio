  ...
  return (
    <div className="">
      <div className="grid grid-cols-7 content-center" id="body">
        ...
        <ul className='border-2 border-white rounded-xl float-left bg-white'>
                {socials.map((social) => (
                    <a href={social.link}><li className="p-2"><img className="w-12 h-12 socialIcon" src={social.icon}/></li></a>
                ))}
            </ul>
        </div>
